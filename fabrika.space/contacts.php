	...
	<div id="main" class="pageStyleLikeHome contactsMain">
		...
		<?php }else{ ?>
			...
			<div id="content" class="clear">
				...
				<div class="simpleTextBlock">
					<p>Мы находимся в здании фабрики сортировки семян на улице Благовещенская, 1 (рядом с Благовещенским собором), ближайшие станции метро – Центральный рынок, Исторический музей. Пешком от Южного железнодорожного вокзала – 7 минут.</p>
				</div>
